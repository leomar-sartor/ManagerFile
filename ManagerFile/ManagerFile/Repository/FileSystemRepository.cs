    ...
    public class FileSystemRepository : IFileSystemRepository
    {
        public IEnumerable<FileSystemObject> SelectMany(string id)
        {
            ...
            if (Directory.Exists(id))
            {
                ...
                {
                    var obj = SelectOneDirectoryInfo(directoryInfo);
                ...
                {
                    var obj = SelectOneFileInfo(fileInfo);
        ...
        {
            var obj = SelectOneFileInfo(new FileInfo(id));
        ...
        private FileSystemObject SelectOneDirectoryInfo(DirectoryInfo info)
        {
            ...
            var obj = SelectOneFileSystemInfo(info);
